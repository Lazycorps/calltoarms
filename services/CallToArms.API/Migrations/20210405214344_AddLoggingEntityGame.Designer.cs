...
namespace CallToArms.Migrations
{
    ...
    [Migration("20210405214344_AddLoggingEntityGame")]
    partial class AddLoggingEntityGame
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CallToArms.Entities.EntityFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CallToArms.Entities.EntityGame", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CallToArms.Entities.GameUser", b =>
                {
                    b.HasOne("CallToArms.Entities.EntityGame", "Game")
                        .WithMany("GameUsers")
